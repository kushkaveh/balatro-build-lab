...
--
-- M3+  run_module('src/hooks.lua')          -- ALL vanilla function wraps
-- M3+  run_module('src/run_config.lua')     -- RunConfig model + validation + defaults
-- M3+  run_module('src/run_injector.lua')   -- config -> challenge ruleset
-- M7+  run_module('src/presets.lua')        -- save/load JSON, missing-mod degradation
-- M4+  run_module('src/ui/buildlab_tab.lua')
-- M4+  run_module('src/ui/main_panel.lua')
